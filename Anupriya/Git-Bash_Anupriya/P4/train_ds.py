...
parser.add_argument('--epochs', dest='epoch_num',type=int)
parser.add_argument('--classes', dest='class_num',type=int)
args=parser.parse_args()

print("Batch: ",args.batch, "Epochs: ",args.epoch_num,"Classes : ",args.class_num)
